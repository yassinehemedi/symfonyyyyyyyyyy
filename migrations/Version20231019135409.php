 ...
 */
final class Version20231019135409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE book (ref INT NOT NULL, author_id_id INT DEFAULT NULL, title VARCHAR(255) NOT NULL, published INT NOT NULL, publication_date DATE NOT NULL, category VARCHAR(255) NOT NULL, INDEX IDX_CBE5A33169CCBE9A (author_id_id), PRIMARY KEY(ref)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
